  ...
  try {
    ...
    const defaultFlags: CreateFeatureFlagInput[] = [
      ...
      },
      {
        ...
        description: "Generate marketing copy, emails, and descriptions",
        category: "ai_features",
        status: "live",
        icon: "sparkles",
        order: 2,
      ...
      {
        slug: "ai_image_enhancement",
        name: "AI Image Enhancement",
        description: "Auto-enhance and retouch photos using AI",
        category: "ai_features",
        status: "coming_soon",
        icon: "sparkles",
        order: 3,
      ...
      },
      {
        ...
        description: "Text message notifications for clients",
        category: "communications",
        status: "coming_soon",
        icon: "message-circle",
        order: 3,
      ...
      {
        slug: "client_portal_messaging",
        name: "Client Portal Messaging",
        description: "Two-way messaging in client portal",
        category: "communications",
        status: "live",
        icon: "message-circle",
        order: 4,
      ...
      // ============ EXPERIMENTAL ============
      {
        slug: "galleries",
        name: "Galleries",
        description: "Photo gallery delivery system",
      ...
      },
      {
        ...
        description: "CRM and client database",
        category: "experimental",
        status: "live",
        icon: "sparkles",
        order: 2,
      ...
      },
      {
        slug: "booking_system",
        name: "Booking System",
        description: "Online booking and scheduling",
        category: "experimental",
        status: "live",
        icon: "calendar",
        order: 3,
      ...
      },
      {
        slug: "workflows",
        name: "Workflows",
        description: "Automated task and email workflows",
        category: "experimental",
        status: "live",
        icon: "sparkles",
        order: 5,
      },
      {
        slug: "questionnaires",
        name: "Questionnaires",
        description: "Client intake questionnaires",
        category: "experimental",
        status: "live",
        icon: "message-circle",
        order: 6,
      ...
      },
      {
        ...
        description: "Customizable portfolio site builder",
        category: "experimental",
        status: "beta",
        icon: "sparkles",
        order: 9,
      ...
      },
      {
        slug: "webhooks",
        name: "Webhooks",
        description: "Outbound webhooks for event notifications",
        category: "system",
        status: "live",
        icon: "bell",
        order: 2,
      ...
      },
      {
        ...
        description: "Support for multiple businesses per account",
        category: "system",
        status: "live",
        icon: "sparkles",
        order: 5,
      ...
      {
        slug: "module_payments",
        name: "Payment Tracking",
        description: "Track payments, deposits, and payment history",
        category: "platform_operations",
        status: "live",
        icon: "credit-card",
        order: 8,
      ...
      {
        slug: "module_expenses",
        name: "Expenses",
        description: "Track business expenses for tax and accounting",
        category: "platform_operations",
        status: "live",
        icon: "receipt",
        order: 9,
      ...
      {
        slug: "module_team_management",
        name: "Team Management",
        description: "Manage team members, roles, and photographer assignments",
        category: "platform_operations",
        status: "live",
        icon: "users-round",
        order: 10,
      ...
      // ============ PLATFORM ADVANCED MODULES ============
      {
        slug: "module_properties",
        name: "Property Websites",
        description: "Single property listing pages for real estate",
        category: "platform_advanced",
        status: "live",
        icon: "building-2",
        order: 1,
      },
      {
        slug: "module_portfolio_websites",
      ...
      {
        slug: "module_ai_assistant",
        name: "AI Assistant",
        description: "AI-powered business automation and insights",
        category: "platform_advanced",
        status: "live",
        icon: "bot",
        order: 7,
      ...
      {
        slug: "module_marketing_kit",
        name: "Marketing Kit",
        description: "Generate marketing materials and social media content",
        category: "platform_advanced",
        status: "live",
        icon: "megaphone",
        order: 8,
      ...
      {
        slug: "module_referrals",
        name: "Referral Program",
        description: "Referral tracking and rewards for client referrals",
        category: "platform_advanced",
        status: "coming_soon",
        icon: "gift",
        order: 9,
      ...
      {
        slug: "module_integrations",
        name: "Integrations",
        description: "Connect with Zapier, QuickBooks, Calendly, and more",
        category: "platform_advanced",
        status: "beta",
        icon: "plug",
        order: 10,
      ...
      {
        slug: "module_tax_prep",
        name: "Tax Preparation",
        description: "Tax preparation wizard and expense categorization",
        category: "platform_advanced",
        status: "live",
        icon: "calculator",
        order: 11,
      ...
      {
        slug: "module_brokerages",
        name: "Brokerage Management",
        description: "Manage real estate brokerage relationships and agents",
        category: "platform_advanced",
        status: "live",
        icon: "landmark",
        order: 12,
