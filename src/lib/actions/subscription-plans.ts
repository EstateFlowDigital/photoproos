...
const DEFAULT_PLANS = [
  {
    ...
    description: "500GB storage for growing photographers",
    ...
    trialDays: 14,
    features: [
      { name: "500GB Storage", featureKey: "storage_gb", featureValue: "500", category: "Storage" },
      { name: "50 Active Galleries", featureKey: "galleries_limit", featureValue: "50", category: "Core" },
      { name: "100 Clients", featureKey: "clients_limit", featureValue: "100", category: "Core" },
      ...
      { name: "Priority Email Support", featureKey: "support_level", featureValue: "email", category: "Support" },
      { name: "3 Team Members", featureKey: "team_members", featureValue: "3", category: "Team" },
      { name: "Gallery Sleep Mode", featureKey: "gallery_sleep", featureValue: "true", category: "Storage" },
      { name: "Additional Storage Available", featureKey: "storage_addon", featureValue: "199_per_10tb", category: "Storage" },
    ],
  },
  {
    name: "Studio",
    ...
    description: "1TB storage for busy studios and teams",
    ...
    trialDays: 14,
    features: [
      { name: "1TB Storage", featureKey: "storage_gb", featureValue: "1000", category: "Storage" },
      { name: "Unlimited Galleries", featureKey: "galleries_limit", featureValue: "unlimited", category: "Core" },
      { name: "Unlimited Clients", featureKey: "clients_limit", featureValue: "unlimited", category: "Core" },
      { name: "Custom Branding", featureKey: "custom_branding", featureValue: "true", category: "Branding" },
      { name: "White-Label Portal", featureKey: "white_label", featureValue: "true", category: "Branding" },
      { name: "Client Portal", featureKey: "client_portal", featureValue: "true", category: "Core" },
      { name: "Online Booking", featureKey: "online_booking", featureValue: "true", category: "Core" },
      { name: "Unlimited Invoicing", featureKey: "invoicing", featureValue: "unlimited", category: "Core" },
      { name: "Contracts & E-Sign", featureKey: "contracts", featureValue: "true", category: "Core" },
      { name: "Priority Phone + Email Support", featureKey: "support_level", featureValue: "priority", category: "Support" },
      ...
      { name: "API & Webhooks Access", featureKey: "api_access", featureValue: "true", category: "Integrations" },
      { name: "Gallery Sleep Mode", featureKey: "gallery_sleep", featureValue: "true", category: "Storage" },
      { name: "Additional Storage Available", featureKey: "storage_addon", featureValue: "199_per_10tb", category: "Storage" },
    ],
  },
  {
    ...
    description: "Unlimited storage with 10TB included for agencies",
    tagline: "For agencies & large teams",
    badgeText: null,
    displayOrder: 3,
    isHighlighted: false,
    monthlyPriceCents: 34900, // $349/mo
    yearlyPriceCents: 335000, // $3350/yr (save ~$838)
    trialDays: 30,
    features: [
      { name: "Unlimited Storage (10TB included)", featureKey: "storage_gb", featureValue: "10000", category: "Storage" },
      { name: "Unlimited Galleries", featureKey: "galleries_limit", featureValue: "unlimited", category: "Core" },
      { name: "Unlimited Clients", featureKey: "clients_limit", featureValue: "unlimited", category: "Core" },
      { name: "Custom Branding", featureKey: "custom_branding", featureValue: "true", category: "Branding" },
