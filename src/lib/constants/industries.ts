...
export const INDUSTRIES: Record<string, IndustryDefinition> = {
  real_estate: {
    ...
    defaultModules: ["galleries", "scheduling", "availability", "invoices", "clients", "properties"],
    color: "#3b82f6", // blue
    sortOrder: 1,
  },
  commercial: {
    ...
    defaultModules: ["galleries", "scheduling", "availability", "invoices", "clients", "contracts", "portfolio_websites"],
    color: "#8b5cf6", // purple
    sortOrder: 2,
  },
  events: {
  ...
  portraits: {
    ...
    defaultModules: ["galleries", "scheduling", "availability", "invoices", "clients", "portfolio_websites"],
    color: "#f97316", // orange
    sortOrder: 4,
  },
  food: {
