...
export const metadata: Metadata = {
  title: "Commercial Photography | PhotoProOS",
    ...
    <main className="relative min-h-screen bg-background">
      ...
      <section className="border-t border-[var(--card-border)] py-16 lg:py-24">
        <div className="mx-auto max-w-[1512px] px-6 lg:px-[124px]">
          <h2 className="mb-12 text-center text-3xl font-bold text-foreground">Built for commercial workflows</h2>
      ...
      <section className="border-t border-[var(--card-border)] py-16 lg:py-24">
        <div className="mx-auto max-w-[1512px] px-6 text-center lg:px-[124px]">
          <h2 className="mb-4 text-2xl font-bold text-foreground md:text-3xl">Ready to elevate your commercial photography business?</h2>
