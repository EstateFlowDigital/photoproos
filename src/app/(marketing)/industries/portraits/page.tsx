...
export default function PortraitsIndustryPage() {
  return (
    <main className="relative min-h-screen bg-background" data-element="industries-portraits-page">
      <section className="relative overflow-hidden border-b border-[var(--card-border)]" data-element="industries-portraits-hero">
      ...
      <section className="border-t border-[var(--card-border)] py-16 lg:py-24" data-element="industries-portraits-features-section">
        <div className="mx-auto max-w-[1512px] px-6 lg:px-[124px]">
          <h2 className="mb-12 text-center text-3xl font-bold text-foreground" data-element="industries-portraits-features-heading">Built for portrait photography</h2>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3" data-element="industries-portraits-features-grid">
      ...
      <section className="border-t border-[var(--card-border)] py-16 lg:py-24" data-element="industries-portraits-cta-section">
        <div className="mx-auto max-w-[1512px] px-6 text-center lg:px-[124px]">
          <h2 className="mb-4 text-2xl font-bold text-foreground md:text-3xl" data-element="industries-portraits-cta-heading">Ready to grow your portrait business?</h2>
          <p className="mb-8 text-foreground-secondary">Join professional portrait photographers using PhotoProOS.</p>
          <Link href="/sign-up" className="inline-flex items-center gap-2 rounded-lg bg-[var(--primary)] px-8 py-3 text-sm font-medium text-white transition-colors hover:bg-[var(--primary)]/90" data-element="industries-portraits-cta-btn">Start free trial</Link>
        </div>
      </section>
    </main>
  );
