      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-[var(--card-border)] bg-[var(--card)] p-6">
            ...
            <div className="space-y-4 text-sm text-foreground-secondary">
              <div className="flex gap-3">
                ...
                <p>Add location notes to help you find the venue easily.</p>
              </div>
              <div className="flex gap-3">
                ...
                <p>Set a deposit to secure the booking.</p>
              </div>
              <div className="flex gap-3">
                ...
                <p>Enable reminders to reduce no-shows.</p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-[var(--card-border)] bg-[var(--card)] p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium text-foreground">4 bookings</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-foreground-muted">This Month</span>
                <span className="text-sm font-medium text-foreground">12 bookings</span>
              </div>
              <div className="flex items-center justify-between">
          ...
          <div className="rounded-xl border border-[var(--card-border)] bg-[var(--card)] p-6">
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--primary)]/10 text-[var(--primary)] text-xs font-medium shrink-0">
                  <span>15</span>
                </div>
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-medium text-foreground truncate">Corporate Headshots</p>
                  <p className="text-xs text-foreground-muted">Tech Solutions Inc • 2:00 PM</p>
                </div>
              </div>
              <div className="flex gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--primary)]/10 text-[var(--primary)] text-xs font-medium shrink-0">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-medium text-foreground truncate">Luxury Estate Photos</p>
                  <p className="text-xs text-foreground-muted">Premier Realty • 10:00 AM</p>
                </div>
              </div>
              <div className="flex gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--primary)]/10 text-[var(--primary)] text-xs font-medium shrink-0">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-medium text-foreground truncate">Restaurant Interiors</p>
                  <p className="text-xs text-foreground-muted">Bella Cucina • 9:00 AM</p>
                </div>
              </div>
            </div>
          </div>
