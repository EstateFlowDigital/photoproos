...
const getDemoBookings = () => {
  ...
  return [
    {
      id: "1",
      title: "Downtown Penthouse Shoot",
      clientName: "John Peterson",
      client: { fullName: "John Peterson", company: "Premier Realty" },
      location: "123 Main St, Downtown",
      status: "confirmed",
      startTime: new Date(today.getTime() + 1000 * 60 * 60 * 10), // Today 10 AM
      endTime: new Date(today.getTime() + 1000 * 60 * 60 * 12), // Today 12 PM
    },
    {
      id: "2",
      title: "Corporate Headshots Session",
      clientName: "Michael Chen",
      client: { fullName: "Michael Chen", company: "Tech Solutions Inc" },
      location: "456 Tech Park, Suite 200",
      status: "confirmed",
      startTime: new Date(today.getTime() + 1000 * 60 * 60 * 14), // Today 2 PM
      endTime: new Date(today.getTime() + 1000 * 60 * 60 * 17), // Today 5 PM
    },
    {
      id: "3",
      title: "Restaurant Interior Photography",
      clientName: "Isabella Romano",
      client: { fullName: "Isabella Romano", company: "Bella Cucina" },
      location: "789 Restaurant Row",
      status: "pending",
      startTime: new Date(today.getTime() + 1000 * 60 * 60 * 24 + 1000 * 60 * 60 * 9), // Tomorrow 9 AM
      endTime: new Date(today.getTime() + 1000 * 60 * 60 * 24 + 1000 * 60 * 60 * 12), // Tomorrow 12 PM
    },
    {
      id: "4",
      title: "Luxury Estate Tour",
      clientName: "Emily Watson",
      client: { fullName: "Emily Watson", company: "Berkshire Properties" },
      location: "1234 Oceanview Dr",
      status: "confirmed",
      startTime: new Date(today.getTime() + 1000 * 60 * 60 * 48 + 1000 * 60 * 60 * 10), // Day after tomorrow 10 AM
      endTime: new Date(today.getTime() + 1000 * 60 * 60 * 48 + 1000 * 60 * 60 * 14), // Day after tomorrow 2 PM
    },
    {
      id: "5",
      title: "Product Launch Event Coverage",
      clientName: "Alex Rivera",
      client: { fullName: "Alex Rivera", company: "Innovate Tech" },
      location: "Tech Convention Center",
      status: "confirmed",
      startTime: new Date(today.getTime() + 1000 * 60 * 60 * 72 + 1000 * 60 * 60 * 18), // 3 days out 6 PM
      endTime: new Date(today.getTime() + 1000 * 60 * 60 * 72 + 1000 * 60 * 60 * 22), // 3 days out 10 PM
    },
  ];
};
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-lg border border-[var(--primary)]/30 bg-[var(--primary)]/10 px-4 py-3">
          <p className="text-sm text-[var(--primary)]">
            <strong>Demo Mode:</strong> Viewing sample booking data.
          </p>
        </div>
