        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-[var(--error)]/30 bg-[var(--error)]/5 p-6">
            ...
            >
              <button
                type="submit"
                className="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-[var(--error)] px-4 py-2 text-sm font-medium text-[var(--error)] transition-colors hover:bg-[var(--error)]/10 sm:w-auto"
              >
