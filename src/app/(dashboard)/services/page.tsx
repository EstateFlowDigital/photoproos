...
export default async function ServicesPage() {
  ...
  return (
    <div className="space-y-6" data-element="services-page">
      ...
      <PageContextNav
        items={[
          { label: "Services", href: "/services", icon: <ServicesIcon className="h-4 w-4" /> },
          { label: "Bundles", href: "/services/bundles", icon: <BundleIcon className="h-4 w-4" /> },
          { label: "Add-ons", href: "/services/addons", icon: <AddonIcon className="h-4 w-4" /> },
        ]}
      />
