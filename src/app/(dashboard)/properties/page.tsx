...
// Demo data for property websites
const demoPropertyWebsites = [
  {
    id: "1",
    ...
    project: {
      ...
      assets: [
        { id: "a1", thumbnailUrl: null },
        { id: "a2", thumbnailUrl: null },
        { id: "a3", thumbnailUrl: null },
      ],
    },
    _count: { leads: 5 },
  },
  {
    ...
    project: {
      ...
      assets: [
        { id: "a4", thumbnailUrl: null },
        { id: "a5", thumbnailUrl: null },
      ],
    },
    _count: { leads: 12 },
  },
...
export default function PropertiesPage() {
  ...
  const filteredWebsites = demoPropertyWebsites.filter((website) => {
    // Filter by status
  ...
  const stats = {
    total: demoPropertyWebsites.length,
    published: demoPropertyWebsites.filter((w) => w.isPublished).length,
    totalViews: demoPropertyWebsites.reduce((acc, w) => acc + w.viewCount, 0),
    totalLeads: demoPropertyWebsites.reduce((acc, w) => acc + w._count.leads, 0),
  };
      ...
      <div className="border-b border-[var(--card-border)] bg-[var(--card)]">
        <div className="mx-auto max-w-7xl px-6 py-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-2xl font-bold text-foreground">Property Websites</h1>
              <p className="mt-1 text-foreground-secondary">
                Create stunning property marketing pages for your clients
              </p>
            </div>
            <Link
              href="/properties/new"
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-[var(--primary)] px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-[var(--primary)]/90"
            >
...
function PropertyCard({ website }: { website: typeof demoPropertyWebsites[0] }) {
  return (
    <Link
