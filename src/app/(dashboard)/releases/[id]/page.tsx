    ...
    <div className="space-y-6">
      ...
      <div className="card p-12 text-center">
        ...
        <p className="text-foreground-muted max-w-md mx-auto mb-8">
          View signed release, download PDF, and manage associated media.
        </p>
        ...
        <div className="text-left max-w-lg mx-auto mb-8">
          ...
          <ul className="space-y-2 text-sm text-foreground-muted">
            <li className="flex items-start gap-2">
              ...
              <span>View signed release document</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
            ...
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
              <span>Associated media management</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
            ...
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
              <span>Resend for signature</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
              <span>Usage tracking and expiration</span>
            </li>
          </ul>
        </div>
