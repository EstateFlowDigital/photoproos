...
export function RocketIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        d="M13.703 4.469a3.75 3.75 0 0 0-3.312.327L6.762 7.154a4.5 4.5 0 0 0-.96.779l-.707.707a3 3 0 0 0-.879 2.121v.177c0 .265.105.52.293.707l4.646 4.646a1 1 0 0 0 .707.293h.177a3 3 0 0 0 2.121-.879l.707-.707a4.5 4.5 0 0 0 .779-.96l2.358-3.629a3.75 3.75 0 0 0 .327-3.312 6.748 6.748 0 0 0-4.328-4.328Zm-3.453 5.281a1.5 1.5 0 1 1 2.121-2.121 1.5 1.5 0 0 1-2.121 2.121Z"
        clipRule="evenodd"
      />
    </svg>
  );
...
export function CheckCircleOutlineIcon({ className, style }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
// ============================================================================
// COMMONLY DUPLICATED ICONS (migrated from inline definitions)
// ============================================================================
...
export function MoreHorizontalIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M3 10a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM8.5 10a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM15.5 11.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z" />
    </svg>
  );
}
...
export function GlobeIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M16.555 5.412a8.028 8.028 0 0 0-3.503-2.81 14.899 14.899 0 0 1 1.663 4.472 8.547 8.547 0 0 0 1.84-1.662ZM13.326 7.825a13.43 13.43 0 0 0-2.413-5.773 8.087 8.087 0 0 0-1.826 0 13.43 13.43 0 0 0-2.413 5.773A8.473 8.473 0 0 0 10 8.5c1.18 0 2.304-.24 3.326-.675ZM6.514 9.376A9.98 9.98 0 0 0 10 10c1.226 0 2.4-.22 3.486-.624a13.54 13.54 0 0 1-.351 3.759A13.54 13.54 0 0 1 10 13.5c-1.102 0-2.169-.132-3.135-.365a13.538 13.538 0 0 1-.351-3.759ZM3.445 5.412a8.547 8.547 0 0 0 1.84 1.662 14.899 14.899 0 0 1 1.663-4.472 8.028 8.028 0 0 0-3.503 2.81ZM2.513 6.656a8.026 8.026 0 0 0-.9 3.344 8.025 8.025 0 0 0 .9 3.344 14.939 14.939 0 0 1 2.545-3.344 14.939 14.939 0 0 1-2.545-3.344ZM6.948 17.398a8.028 8.028 0 0 1-3.503-2.81 8.548 8.548 0 0 1 1.84-1.662 14.899 14.899 0 0 0 1.663 4.472ZM10.087 18a8.087 8.087 0 0 0 1.826 0 13.43 13.43 0 0 0 2.413-5.773A8.473 8.473 0 0 1 10 11.5c-1.18 0-2.304.24-3.326.675A13.43 13.43 0 0 0 10.087 18ZM13.052 17.398a14.899 14.899 0 0 0 1.663-4.472 8.547 8.547 0 0 1 1.84 1.662 8.028 8.028 0 0 1-3.503 2.81ZM17.487 6.656a14.939 14.939 0 0 0-2.545 3.344 14.939 14.939 0 0 0 2.545 3.344 8.026 8.026 0 0 0 .9-3.344 8.026 8.026 0 0 0-.9-3.344Z" />
    </svg>
  );
}
...
export function GalleryPlaceholderIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
...
export function TagIcon({ className }: IconProps) {
  return (
    ...
    >
      <path
        fillRule="evenodd"
        d="M4.5 2A2.5 2.5 0 0 0 2 4.5v2.879a2.5 2.5 0 0 0 .732 1.767l7.5 7.5a2.5 2.5 0 0 0 3.536 0l2.878-2.878a2.5 2.5 0 0 0 0-3.536l-7.5-7.5A2.5 2.5 0 0 0 7.38 2H4.5ZM5 6a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"
        clipRule="evenodd"
      />
    </svg>
  );
...
export function CheckboxIcon({ className }: IconProps) {
  return (
    ...
    >
      <path
        fillRule="evenodd"
        d="M3 4.25A2.25 2.25 0 0 1 5.25 2h9.5A2.25 2.25 0 0 1 17 4.25v11.5A2.25 2.25 0 0 1 14.75 18h-9.5A2.25 2.25 0 0 1 3 15.75V4.25Zm2.25-.75a.75.75 0 0 0-.75.75v11.5c0 .414.336.75.75.75h9.5a.75.75 0 0 0 .75-.75V4.25a.75.75 0 0 0-.75-.75h-9.5Z"
        clipRule="evenodd"
      />
    </svg>
  );
...
export function CreateIcon({ className }: IconProps) {
  return (
    ...
    >
      <path
        fillRule="evenodd"
        d="M4.5 2A1.5 1.5 0 0 0 3 3.5v13A1.5 1.5 0 0 0 4.5 18h11a1.5 1.5 0 0 0 1.5-1.5V7.621a1.5 1.5 0 0 0-.44-1.06l-4.12-4.122A1.5 1.5 0 0 0 11.378 2H4.5Zm4.75 6.75a.75.75 0 0 1 1.5 0v2.25h2.25a.75.75 0 0 1 0 1.5h-2.25v2.25a.75.75 0 0 1-1.5 0v-2.25H7a.75.75 0 0 1 0-1.5h2.25V8.75Z"
        clipRule="evenodd"
      />
    </svg>
  );
...
export function NoteIcon({ className }: IconProps) {
  return (
    ...
    >
      <path
        fillRule="evenodd"
        d="M4.5 2A1.5 1.5 0 0 0 3 3.5v13A1.5 1.5 0 0 0 4.5 18h11a1.5 1.5 0 0 0 1.5-1.5v-13A1.5 1.5 0 0 0 15.5 2h-11ZM6 6.75A.75.75 0 0 1 6.75 6h6.5a.75.75 0 0 1 0 1.5h-6.5A.75.75 0 0 1 6 6.75Zm0 3A.75.75 0 0 1 6.75 9h6.5a.75.75 0 0 1 0 1.5h-6.5A.75.75 0 0 1 6 9.75Zm0 3a.75.75 0 0 1 .75-.75h3.5a.75.75 0 0 1 0 1.5h-3.5a.75.75 0 0 1-.75-.75Z"
        clipRule="evenodd"
      />
    </svg>
  );
...
export function TabletIcon({ className }: IconProps) {
  return (
    ...
    >
      <path
        fillRule="evenodd"
        d="M5 1a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V4a3 3 0 0 0-3-3H5Zm5 14.5a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5ZM3.5 4a1.5 1.5 0 0 1 1.5-1.5h10A1.5 1.5 0 0 1 16.5 4v9a.5.5 0 0 1-.5.5H4a.5.5 0 0 1-.5-.5V4Z"
        clipRule="evenodd"
      />
    </svg>
  );
...
export function ExpiredIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
...
export function GiftIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
      <path fillRule="evenodd" d="M4.5 2A2.5 2.5 0 0 0 2 4.5v2.879a2.5 2.5 0 0 0 .732 1.767l7.5 7.5a2.5 2.5 0 0 0 3.536 0l2.878-2.878a2.5 2.5 0 0 0 0-3.536l-7.5-7.5A2.5 2.5 0 0 0 7.38 2H4.5ZM5 6a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" clipRule="evenodd" />
    </svg>
  );
}
...
export function BankIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
      <path fillRule="evenodd" d="M1 2.75A.75.75 0 0 1 1.75 2h16.5a.75.75 0 0 1 0 1.5H18v8.75A2.75 2.75 0 0 1 15.25 15h-1.072l.798 3.06a.75.75 0 0 1-1.452.38L12.7 15H7.3l-.824 3.44a.75.75 0 1 1-1.452-.38l.798-3.06H4.75A2.75 2.75 0 0 1 2 12.25V3.5h-.25A.75.75 0 0 1 1 2.75ZM7.373 13.5l-.267 1.116 1.07-.683a.75.75 0 0 1 .807 0l1.067.683-.267-1.116H7.373Zm2.377-2.262a.75.75 0 0 0-.75-.75h-.25a.75.75 0 0 0 0 1.5H9a.75.75 0 0 0 .75-.75ZM10.75 6a.75.75 0 0 0-.75.75v3a.75.75 0 0 0 1.5 0v-3a.75.75 0 0 0-.75-.75ZM6.75 8a.75.75 0 0 0-.75.75v1.5a.75.75 0 0 0 1.5 0v-1.5A.75.75 0 0 0 6.75 8ZM13 8.75a.75.75 0 0 1 1.5 0v1.5a.75.75 0 0 1-1.5 0v-1.5Z" clipRule="evenodd" />
    </svg>
  );
}
...
export function MailOutlineIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
...
export function GoogleCalendarIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M19.5 3h-3V1.5a.75.75 0 0 0-1.5 0V3h-6V1.5a.75.75 0 0 0-1.5 0V3h-3A2.25 2.25 0 0 0 2.25 5.25v13.5A2.25 2.25 0 0 0 4.5 21h15a2.25 2.25 0 0 0 2.25-2.25V5.25A2.25 2.25 0 0 0 19.5 3ZM4.5 18.75V9h15v9.75a.75.75 0 0 1-.75.75H5.25a.75.75 0 0 1-.75-.75Z" />
    </svg>
  );
}
...
export function DropboxIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M12 6.134 6 9.866l6 3.732 6-3.732L12 6.134Zm0 1.732L8.536 10l3.464 2.134L15.464 10 12 7.866ZM6 14.134l6 3.732 6-3.732-6-3.732-6 3.732Zm6 1.732-3.464-2.134L12 11.598l3.464 2.134L12 15.866Z" />
    </svg>
  );
}
...
export function QuickBooksIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0Zm4.5 16.5h-2.25v-2.25h-1.5v2.25h-1.5v-2.25H9.75c-.414 0-.75-.336-.75-.75v-6c0-.414.336-.75.75-.75h1.5v2.25h1.5V7.5h1.5v2.25h2.25c.414 0 .75.336.75.75v5.25c0 .414-.336.75-.75.75Z" />
    </svg>
  );
}
...
export function ZapierIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0Zm5.894 13.894-3.536 3.536a2.673 2.673 0 0 1-3.775 0L7.047 13.894a2.673 2.673 0 0 1 0-3.775l3.536-3.536a2.673 2.673 0 0 1 3.775 0l3.536 3.536a2.673 2.673 0 0 1 0 3.775Z" />
    </svg>
  );
}

export function MailchimpIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0Zm4.5 15.75c-.75.75-2.25 1.5-4.5 1.5s-3.75-.75-4.5-1.5c-.375-.375-.375-.75 0-1.125.375-.375.75-.375 1.125 0 .75.75 1.875 1.125 3.375 1.125s2.625-.375 3.375-1.125c.375-.375.75-.375 1.125 0 .375.375.375.75 0 1.125ZM9 10.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Zm6 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Z" />
    </svg>
  );
}
...
export function GoogleDriveIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M7.71 3.5 1.15 15l2.79 4.82L10.5 8.33 7.71 3.5ZM8.85 3.5h6.3L21.71 15h-6.3L8.85 3.5ZM15.86 15.5 13.07 20.33H2.43L5.22 15.5h10.64ZM16.43 15.5h6.3l-2.79 4.83h-6.3l2.79-4.83Z" />
    </svg>
  );
}
...
export function CalendlyIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M19.5 3h-3V1.5a.75.75 0 0 0-1.5 0V3h-6V1.5a.75.75 0 0 0-1.5 0V3h-3A2.25 2.25 0 0 0 2.25 5.25v13.5A2.25 2.25 0 0 0 4.5 21h15a2.25 2.25 0 0 0 2.25-2.25V5.25A2.25 2.25 0 0 0 19.5 3ZM12 16.5a4.5 4.5 0 1 1 0-9 4.5 4.5 0 0 1 0 9Zm0-7.5a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z" />
    </svg>
  );
}
...
export function NotionIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M4.459 4.208c.746.606 1.026.56 2.428.466l13.215-.793c.28 0 .047-.28-.046-.326L18.24 2.28c-.42-.326-.98-.7-2.055-.606L3.479 2.92c-.466.046-.56.28-.374.466l1.354 1.822Zm.793 3.126v13.939c0 .746.373 1.026 1.214.98l14.523-.84c.84-.046 1.026-.56 1.026-1.166V6.334c0-.606-.233-.932-.746-.886l-15.177.886c-.56.046-.84.326-.84.886Zm14.383.746c.093.42 0 .84-.42.886l-.7.14v10.264c-.606.327-1.166.513-1.633.513-.746 0-.933-.233-1.493-.933l-4.573-7.186v6.953l1.446.327s0 .84-1.166.84l-3.22.186c-.093-.186 0-.653.327-.746l.84-.233V9.854L7.26 9.668c-.093-.42.14-1.026.793-1.073l3.453-.233 4.76 7.28v-6.44l-1.213-.14c-.093-.513.28-.886.746-.932l3.22-.187ZM2.667 1.067l13.4-.84c1.645-.14 2.055-.046 3.08.7l4.247 2.987c.7.513.933.653.933 1.213V18.8c0 1.026-.373 1.632-1.68 1.726l-15.457.933c-.98.047-1.447-.093-1.96-.746L1.22 16.467C.666 15.72.386 15.167.386 14.387V2.84C.386 1.814.76 1.161 2.667 1.067Z" />
    </svg>
  );
}

export function DocuSignIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
...
export function CurrencyIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
      ...
      <path fillRule="evenodd" d="M18 10a8 8 0 1 1-16 0 8 8 0 0 1 16 0Zm-8-6a.75.75 0 0 1 .75.75v.316a3.78 3.78 0 0 1 1.653.713c.426.33.744.74.925 1.2a.75.75 0 0 1-1.395.55 1.35 1.35 0 0 0-.447-.563 2.187 2.187 0 0 0-.736-.363V9.3c.698.093 1.383.32 1.959.696.787.514 1.29 1.27 1.29 2.13 0 .86-.504 1.616-1.29 2.13-.576.377-1.261.603-1.96.696v.299a.75.75 0 1 1-1.5 0v-.3a3.78 3.78 0 0 1-1.653-.713 2.42 2.42 0 0 1-.925-1.199.75.75 0 0 1 1.395-.55c.12.303.358.541.684.733.306.18.658.304 1.049.367v-2.868a3.78 3.78 0 0 1-1.959-.696c-.787-.514-1.29-1.27-1.29-2.13 0-.86.504-1.616 1.29-2.13a3.78 3.78 0 0 1 1.96-.696V4.75A.75.75 0 0 1 10 4Z" clipRule="evenodd" />
    </svg>
  );
}
...
export function TaskIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
      <path fillRule="evenodd" d="M3 5.75A.75.75 0 0 1 3.75 5h16.5a.75.75 0 0 1 0 1.5H3.75A.75.75 0 0 1 3 5.75ZM3 10a.75.75 0 0 1 .75-.75h16.5a.75.75 0 0 1 0 1.5H3.75A.75.75 0 0 1 3 10Zm0 4.25a.75.75 0 0 1 .75-.75h16.5a.75.75 0 0 1 0 1.5H3.75a.75.75 0 0 1-.75-.75Z" clipRule="evenodd" />
    </svg>
  );
}
...
export function ChatIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
      <path fillRule="evenodd" d="M10 2c-2.236 0-4.43.18-6.57.524C1.993 2.755 1 3.924 1 5.286v5.448c0 1.457 1.116 2.686 2.612 2.842 1.164.122 2.343.213 3.538.273v3.902c0 .26.32.39.51.22l4.14-3.74c1.295-.06 2.576-.159 3.838-.303C17.116 13.42 18 12.19 18 10.734V5.286c0-1.362-.993-2.531-2.43-2.762A41.29 41.29 0 0 0 10 2Z" clipRule="evenodd" />
    </svg>
  );
}
...
export const GalleryPauseIcon = PauseIcon;
