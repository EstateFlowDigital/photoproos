...
export function BulkExportButton({ statusFilter, invoiceCount }: BulkExportButtonProps) {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      showToast(error instanceof Error ? error.message : "Failed to export invoices", "error");
    } finally {
