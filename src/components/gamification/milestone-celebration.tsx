...
export function MilestoneCelebration({
  ...
  const descId = `milestone-desc-${milestone.id}`;
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="absolute right-4 top-4 rounded-lg p-1 text-[var(--foreground-muted)] hover:bg-[var(--background-hover)] hover:text-[var(--foreground)] transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:ring-offset-2 focus:ring-offset-[var(--card)]"
            >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[var(--warning)] to-[var(--error)] px-4 py-2 text-sm font-semibold text-white"
              role="status"
              aria-live="polite"
            >
            ...
            <motion.button
              ...
              onClick={onDismiss}
              className="mt-6 w-full rounded-lg bg-[var(--background-secondary)] py-3 font-medium text-[var(--foreground)] hover:bg-[var(--background-hover)] transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:ring-offset-2 focus:ring-offset-[var(--card)]"
            >
              Keep Going!
            </motion.button>
          </motion.div>
...
export function MilestoneToast({ milestone, onDismiss, className }: MilestoneToastProps) {
  ...
  return (
    <motion.div
      ...
      role="alert"
      aria-live="polite"
      aria-label={`Milestone achieved: ${milestone.name}. ${milestone.description}`}
      className={cn(
    ...
    >
      ...
      <button
        ...
        className="rounded-lg p-1 text-[var(--foreground-muted)] hover:bg-[var(--background-hover)] hover:text-[var(--foreground)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)]"
      >
