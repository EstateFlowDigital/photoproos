          ...
          {filteredIntegrations.map((integration, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="mb-4 flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[var(--foreground-muted)]/15 transition-transform duration-300 group-hover:scale-110">
